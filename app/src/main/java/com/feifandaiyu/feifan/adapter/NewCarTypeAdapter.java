...
public class NewCarTypeAdapter extends BaseAdapter implements View.OnClickListener {
    List<BrandCarUrlBean.ListBean> list;
    private Context context;
    private OnTextclicklister onTextclicklister;

    public NewCarTypeAdapter(Context context, List list, OnTextclicklister onTextclicklister) {
        this.list = list;
