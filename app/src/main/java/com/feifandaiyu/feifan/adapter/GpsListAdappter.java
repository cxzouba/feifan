...
public class GpsListAdappter extends BaseAdapter {
    private List<GpsType.ListBean> list;
    ...
    public GpsListAdappter(Context context, List<GpsType.ListBean> list, OnRadiobuttonclick radiobuttonclick) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = convertView.inflate(context, R.layout.item_gps_type, null);
...
//            holder.textView10.setText("张三" + position);
        holder.tvLeftnaem.setText(list.get(position).getModel());
        holder.radioButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GpsListAdappter.this.notifyDataSetChanged();
            }
        });
        boolean res = false;
