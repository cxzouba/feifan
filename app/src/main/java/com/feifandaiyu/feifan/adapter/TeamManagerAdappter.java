...
public class TeamManagerAdappter extends BaseAdapter {
    ...
    public TeamManagerAdappter(Context context, List<TeamMannerBean.ListBean> list, OnRadiobuttonclick radiobuttonclick) {
        this.list = list;
...
//            holder.textView10.setText("张三" + position);
        holder.radioButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TeamManagerAdappter.this.notifyDataSetChanged();
            }
        });
        boolean res = false;
