...
import com.feifandaiyu.feifan.activity.cheshang.PersonalCheshangPicActivity;
import com.feifandaiyu.feifan.activity.cheshang.ShowPersonalCheshang;
...
public class CheshangPersonalFragment extends Fragment {
...
//            startActivity(new Intent(getActivity(), PingGuShiPingGuActivity.class));
    ...
    CheshangAdapter.OnButtonClickLisetrner2 btnlistener2 = new CheshangAdapter.OnButtonClickLisetrner2() {
        ...
        public void onButtonClick(int positon) {
            firstVisiblePosition = lvDpg.getFirstVisiblePosition();
            LogUtils.e(list.get(positon).getId());
            PreferenceUtils.setString(getActivity(), "cheshangId", list.get(positon).getId());
            startActivity(new Intent(getActivity(), PersonalCheshangPicActivity.class));
...
//                        refreshDpg.setRefreshing(false);
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        Gson gson = new Gson();
                        hud.dismiss();
                        CheshangListBean bean = null;
                        try {
                            bean = gson.fromJson(json, CheshangListBean.class);
                            list = bean.getList();
...
//                        refreshDpg.setRefreshing(false);
        ...
        lvDpg.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(getActivity(), ShowPersonalCheshang.class));
            }
        });
    }
