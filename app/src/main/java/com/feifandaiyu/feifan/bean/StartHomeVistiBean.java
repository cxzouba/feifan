...
public class StartHomeVistiBean {
    ...
    public static class ListBean {
        /**
         * userId : 141
         * car : [{"id":5,"username":"sfasd"},{"id":6,"username":"富士达"}]
