...
public class UpdateCost1Activity extends BaseActivity implements TextWatcher {
...
//    TextView tvShijiPrice;
    ...
    TextView tvYuegong;
    @InjectView(R.id.rb_yizudaigou)
    RadioButton rbYizudaigou;
    ...
    protected int getContentView() {
        return R.layout.activity_cost_new;
    }
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        hud = KProgressHUD.create(UpdateCost1Activity.this)
...
//        System.out.println(userId + "===" + carId + "====" + isNew);
        ...
        post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        LogUtils.i("updateCost1Show----------------->>>>>>." + e);
                        hud.dismiss();
                        MyToast.show(UpdateCost1Activity.this, "联网失败...");

                    }

                    @Override
                    public void onResponse(String response, int id) {
                        LogUtils.i("updateCost1Show----------------->>>>>>." + response);
                        ...
                        if (postCostBean.getCode() == 1) {
                            ...
                            if (postCostBean.getList().getRentType().equals("直租")) {
                                ...
                                rbYizudaigou.setEnabled(false);
                            } else if (postCostBean.getList().getRentType().equals("回租")) {
                                rbHuizu.setChecked(true);
                                rbZhizu.setEnabled(false);
                                rbYizudaigou.setEnabled(false);
                            } else if (postCostBean.getList().getRentType().equals("以租代购")) {
                                rbYizudaigou.setChecked(true);
                                rbZhizu.setEnabled(false);
                                rbHuizu.setEnabled(false);
                            }
                            ...
                            if (postCostBean.getList().getLoanPrice().equals("-1")) {
                                ...
                                tvGouzhishui.setText(postCostBean.getList().getPurchaseTax());
...
//                            if (postCostBean.getList().getDealer().equals("-1")) {
//                                rebate = 0;
//                            } else {
//                                rebate = Double.parseDouble(postCostBean.getList().getDealer());
//                            }
                            ...
                            new AlertDialog.Builder(UpdateCost1Activity.this)
    ...
    private void initListener() {
        tvLilv.addTextChangedListener(UpdateCost1Activity.this);
        etShangxian.addTextChangedListener(UpdateCost1Activity.this);
        etQiangxian.addTextChangedListener(UpdateCost1Activity.this);
        tvGpsPrice.addTextChangedListener(UpdateCost1Activity.this);
        tvGouzhishui.addTextChangedListener(UpdateCost1Activity.this);
        etDaikuane.addTextChangedListener(UpdateCost1Activity.this);
    }
...
//                            tvGouzhishui.setText(String.valueOf((Double.parseDouble(etFapiao.getText().toString().equals("") ? "0" : etFapiao.getText().toString()) * 9945) / 100000));
                            ...
                            MyToast.show(UpdateCost1Activity.this, bean.getMsg());
                        }
    ...
    public void onViewClicked(View view) {
        bottomPopupOption = new BottomPopupOption(UpdateCost1Activity.this);
...
//                System.out.println("lirun=" + s);
                ...
                if (!StringUtils.isEmpty(etFapiao.getText().toString())
                    ...
                    if (rbZhizu.isChecked()) {
                        if (d <= Double.parseDouble(etFapiao.getText().toString()) * 0.9) {
                            hud.show();
                            postData();

                        } else {

                            MyToast.show(UpdateCost1Activity.this, "选择直租时，贷款额不得大于发票价的90%");

                        }
                    } else if (rbHuizu.isChecked()) {

                        if (d <= Double.parseDouble(etFapiao.getText().toString()) * 0.85) {
                            ...
                            MyToast.show(UpdateCost1Activity.this, "选择回租时，贷款额不得大于发票价的85%");

                        }
                    } else if (rbYizudaigou.isChecked()) {
                        ...
                        MyToast.show(UpdateCost1Activity.this, "请先选择贷款类型");
                    }

                } else {

                    MyToast.show(UpdateCost1Activity.this, "请填写全部信息后点击保存");
...
//                        bank_interest = bean.getPeriods36().get(0).getBank_interest();
                    ...
                    MyToast.show(UpdateCost1Activity.this, "请先选择贷款期数");
    ...
    private void postData() {
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    @Override
                    public void onError(Call call, Exception e, int id) {
                        System.out.println("Updatecost1____________________>>>>>" + e);
                        hud.dismiss();
                        MyToast.show(UpdateCost1Activity.this, "联网失败");
                    }
                    ...
                    @Override
                    public void onResponse(String response, int id) {
                        LogUtils.e("Updatecost1----------------->>>>>>" + response);
                        String json = response;
                        Gson gson = new Gson();
                        ...
                        if (postCostBean.getCode() == 1) {
                            MyToast.show(UpdateCost1Activity.this, "费用信息保存成功");
                            finish();
                            int enterAnim0 = R.anim.pre_enter;// 进入的activity对应的动画资源
                            int exitAnim0 = R.anim.pre_exit;// 结束的activity对应的动画资源
                            overridePendingTransition(enterAnim0, exitAnim0);
                        } else if (postCostBean.getCode() == 0) {
                            MyToast.show(UpdateCost1Activity.this, postCostBean.getMsg());
                        }
                        hud.dismiss();
                    }
                });
...
//                    * Double.parseDouble(etDaikuane.getText().toString().equals("") ? "0" : etDaikuane.getText().toString()));
            ...
            e.printStackTrace();
            MyToast.show(UpdateCost1Activity.this, "输入有误");
        }
    }
