...
public class UpdateCompanyVideoActivity extends BaseActivity implements View.OnClickListener {
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (bean.getCode() == 1) {
                            ...
                            vvVideo.setMediaController(new MediaController(UpdateCompanyVideoActivity.this));
                            ...
                            new AlertDialog.Builder(UpdateCompanyVideoActivity.this)
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bt_video:
                final BottomPopupOption bottomPopupOption = new BottomPopupOption(UpdateCompanyVideoActivity.this);
                ...
                bottomPopupOption.setItemClickListener(new BottomPopupOption.onPopupWindowItemClickListener() {
                    ...
                    public void onItemClick(int position) {
                        if (position == 0) {
                            PictureConfig.getInstance().init(options).startOpenCamera(UpdateCompanyVideoActivity.this, new ResultCa(imageView));
                            bottomPopupOption.dismiss();
                        } else if (position == 1) {

                            MyToast.show(UpdateCompanyVideoActivity.this, "暂不支持视频从相册选择");
                            finish();
                            bottomPopupOption.dismiss();
                        }
                    }
            ...
            case R.id.tv_next:
                ...
                if (selectMedia.size() > 0) {
                    hud = KProgressHUD.create(UpdateCompanyVideoActivity.this)
                    ...
                    MyToast.show(UpdateCompanyVideoActivity.this, "请添加视频");
                }
                                ...
                                post()
                                        ...
                                        .execute(new StringCallback() {
                                            ...
                                            public void onResponse(String response, int id) {
                                                ...
                                                if (bean.getCode() == 1) {
//                                                    startActivity(new Intent(UpdateCompanyVideoActivity.this, TeamManager2Activity.class));
                                                    MyToast.show(UpdateCompanyVideoActivity.this, "企业视频保存成功");
                                                    finish();
                                                    // 设置过渡动画
                                                    int enterAnim0 = R.anim.pre_enter;// 进入的activity对应的动画资源
                                                    int exitAnim0 = R.anim.pre_exit;// 结束的activity对应的动画资源
                                                    ...
                                                    MyToast.show(UpdateCompanyVideoActivity.this, bean.getMsg());
                                                }
            ...
            MyToast.show(UpdateCompanyVideoActivity.this, "请拍摄视频");
        }
    }
    ...
    class ResultCa implements PictureConfig.OnSelectResultCallback {
        ...
        public void onSelectSuccess(List<LocalMedia> resultList) {
            ...
            if (media.isCut() && !media.isCompressed()) {
                ...
                // 原图地址
                path = media.getPath();
                Glide.with(UpdateCompanyVideoActivity.this).load(path).thumbnail(0.5f).into(imageView);
