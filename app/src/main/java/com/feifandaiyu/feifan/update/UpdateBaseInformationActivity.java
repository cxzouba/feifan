...
public class UpdateBaseInformationActivity extends BaseActivity implements TextWatcher {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        hud = KProgressHUD.create(UpdateBaseInformationActivity.this)
...
//        System.out.println(loanPrice);
        ...
        price = 0.00;
        try {
            price = Double.parseDouble(loanPrice == null ? "0" : loanPrice);
...
//        }
    ...
    private void initData() {
        ...
        post()
                .url(Constants.URLS.BASEURL + "UserInfo/information")
                .addParams("userId", userId)
                .build()
                .execute(new StringCallback() {
                    @Override
                    public void onError(Call call, Exception e, int id) {
                        LogUtils.i("updatBaseShow----------------->>>>>>." + e);
                        MyToast.show(UpdateBaseInformationActivity.this, "联网失败...");
                        hud.dismiss();
                    }

                    @Override
                    public void onResponse(String response, int id) {
                        LogUtils.i("updateBaseShow----------------->>>>>>." + response);
                        String json = response;
                        Gson gson = new Gson();
                        BaseInformationBean bean = gson.fromJson(json, BaseInformationBean.class);

                        hud.dismiss();

                        if (bean.getCode() == 1) {

                            if (bean.getList().getIsguarantee().equals("1")) {
                                rbYes.setChecked(true);
                                rbNo.setEnabled(false);
                            } else if (bean.getList().getIsguarantee().equals("2")) {
                            ...
                            tvBirthday.setText(bean.getList().getBirthday());
                            tvSex.setText(bean.getList().getSex());
                            tvSex.setTextColor(Color.GRAY);
                            tvSex.setEnabled(false);
                            tvMarriage.setText(bean.getList().getIsMarry());
                            tvMarriage.setTextColor(Color.GRAY);
                            tvMarriage.setEnabled(false);
                            tvEducation.setText(bean.getList().getEducation());
                            etProfession.setText(bean.getList().getOccupation());
                            etMonthIncome.setText(bean.getList().getMonthlyIncome());
                            etYearIncome.setText(bean.getList().getAnnualncome());
                            tvHouseType.setText(bean.getList().getHousing());
                            etMonthIncome.setText(bean.getList().getMonthlyIncome());
                            etCompanyName.setText(bean.getList().getCorporateName());
                            ...
                            etCompanyPhone.setText(bean.getList().getCorporateMobile());
                            etCompanyType.setText(bean.getList().getUnitProperty());


                            province1 = bean.getList().getWorkProvince();
                            city1 = bean.getList().getWorkCity();
                            area1 = bean.getList().getWorkArea();

                            province3 = bean.getList().getProvince();
                            city3 = bean.getList().getCity();
                            area3 = bean.getList().getArea();
                            ...
                            tvCompanyHome.setText(province1 + city1 + area1);

                            tvHome.setText(province3 + city3 + area3);

                            etCompanyAddr.setText(bean.getList().getWorkAddress());
                            tvWorkTime.setText(bean.getList().getInductionTime());
                            etRemarks.setText(bean.getList().getRemarks());

                        } else if (bean.getCode() == 0) {
                            new AlertDialog.Builder(UpdateBaseInformationActivity.this)
    ...
    public void onViewClicked(View view) {
        bottomPopupOption = new BottomPopupOption(UpdateBaseInformationActivity.this);
...
//                    LogUtils.d("--------------->>>" +!(!tvMarriage.getText().toString().equals("已婚") && price > 200000 && rbNo.isChecked()));
                    MyToast.show(UpdateBaseInformationActivity.this, "如果贷款额大于20万，且客户没有配偶，必须选择共借人");
                    return;
                } else {
                    postMessage();
                }
    ...
    private void showIncome() {
        ...
        final Dialog builder = new Dialog(UpdateBaseInformationActivity.this);
...
//                        LogUtils.i(list1.size() + "---------------->>>>>>>>");
                        adapter = new IncomeAdapter(UpdateBaseInformationActivity.this, list_income);
...
//        }
        ...
        OkHttpUtils
                .post()
                .url(Constants.URLS.BASEURL + "UserUpdate/editUser")
                .addParams("userId", userId)
                ...
                .addParams("workProvince", province == null ? province1 : province)
                .addParams("workCity", city == null ? city1 : city)
                .addParams("workArea", district == null ? area1 : district)
                ...
                .addParams("province", province2 == null ? province3 : province2)
                .addParams("city", city2 == null ? city3 : city2)
                .addParams("area", district2 == null ? area3 : district2)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        ...
                        hud.dismiss();
                        MyToast.show(UpdateBaseInformationActivity.this, "网络连接失败");
                    }
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (baseInformationBean.getCode() == 0) {
                            MyToast.show(UpdateBaseInformationActivity.this, baseInformationBean.getMsg());
                            return;
                        }
                        if (baseInformationBean.getCode() == 1) {
                            ...
                            MyToast.show(UpdateBaseInformationActivity.this, "客户基本信息保存成功");
...
//        int color2 = getResources().getColor(R.color.beixuanchengshi);
        ...
        String json = AssetsUtils.readText(UpdateBaseInformationActivity.this, "city.json");
        data.addAll(JSON.parseArray(json, AddressPicker.Province.class));
        AddressPicker picker = new AddressPicker(UpdateBaseInformationActivity.this, data);
...
//        picker.setTextColor(color1, color2);
        picker.setOnAddressPickListener(new AddressPicker.OnAddressPickListener() {
            ...
            public void onAddressPicked(String province, String city, String county) {
                ...
                //省
                UpdateBaseInformationActivity.this.province = province;
//                //市
                UpdateBaseInformationActivity.this.city = city;
//                //区
                UpdateBaseInformationActivity.this.district = county;
            }
        });
        picker.show();
    }
...
//        picker.setTextColor(color1, color2);
        picker.setOnAddressPickListener(new AddressPicker.OnAddressPickListener() {
            ...
            public void onAddressPicked(String province, String city, String county) {
                ...
                //省
                UpdateBaseInformationActivity.this.province2 = province;
//                //市
                UpdateBaseInformationActivity.this.city2 = city;
//                //区
                UpdateBaseInformationActivity.this.district2 = county;
            }
        });
        picker.show();
    }
