...
public class UpdateCautionerPicActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        hud = KProgressHUD.create(UpdateCautionerPicActivity.this)
    ...
    private void initData() {
        ...
        post()
                .url(Constants.URLS.BASEURL + "UserInfo/gpic")
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        LogUtils.i("showCautionerPic----------------->>>>>>." + e);
//                        hud.dismiss();
                        MyToast.show(UpdateCautionerPicActivity.this, "联网失败...");
                    }

                    @Override
                    public void onResponse(String response, int id) {
                        LogUtils.i("showCautionerPic----------------->>>>>>." + response);
...
//                        hud.dismiss();
                        ...
                        if (updateReportBean.getCode() == 1) {
                            ...
                            mygridview.setAdapter(new MyReportAdapter(UpdateCautionerPicActivity.this, updateReportBean));
                            gid = updateReportBean.getGid();
                        } else if (updateReportBean.getCode() == 0) {
                            new AlertDialog.Builder(UpdateCautionerPicActivity.this)
    ...
    private void initRecyclerView() {
        ...
        adapter1 = new GridImageAdapter(UpdateCautionerPicActivity.this, onAddPicClickListener1);
        adapter1.setList(selectMedia);
        adapter1.setSelectMax(maxSelectNum);
        FullyGridLayoutManager manager = new FullyGridLayoutManager(UpdateCautionerPicActivity.this, 3, GridLayoutManager.VERTICAL, false);
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        ...
                        PictureConfig.getInstance().externalPicturePreview(UpdateCautionerPicActivity.this, position, selectMedia);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(UpdateCautionerPicActivity.this, selectMedia.get(position - 1).getPath());
                        }
                        break;
                    default:
                }
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    ...
                    themeStyle = ContextCompat.getColor(UpdateCautionerPicActivity.this, R.color.blue);//设置主题样式
                    checkedBoxDrawable = R.drawable.select_cb;//设置图片勾选样式
                    previewColor = ContextCompat.getColor(UpdateCautionerPicActivity.this, R.color.tab_color_true);
                    completeColor = ContextCompat.getColor(UpdateCautionerPicActivity.this, R.color.tab_color_true);
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(UpdateCautionerPicActivity.this, resultCallback);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(UpdateCautionerPicActivity.this, resultCallback);
                    }
                    break;
                case 1:
                    // 删除图片
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_next) {
            ...
            if (updateReportBean.getList().size() + selectMedia.size() > 0) {
                showProgressDialog();
...
//        String userId = PreferenceUtils.getString(UpdateCautionerPicActivity.this, "userId");
        ...
        post()
                .url(Constants.URLS.BASEURL + "UserUpdate/editGpic")
                .addParams("userId", userId)
                .addParams("flag", "0")
                ...
                .execute(new StringCallback() {
                    @Override
                    public void onError(Call call, Exception e, int id) {
                        LogUtils.e("EditCautionerPic------------->>>>" + e);
                        progressDialog.dismiss();
                        MyToast.show(UpdateCautionerPicActivity.this, "服务器链接失败，请联系管理员");
                    }


                    @Override
                    public void onResponse(String response, int id) {
                        LogUtils.e("EditCautionerPic------------->>>>" + response);
                        progressDialog.dismiss();
                        String json = response;
                        Gson gson = new Gson();
                        ...
                        try {
                            ...
                            MyToast.show(UpdateCautionerPicActivity.this, "服务器连接失败");
                        }
...
//                            startActivity(new Intent(UpdateCustomeReport.this, StartHomeVisitActivity.class));
                            MyToast.show(UpdateCautionerPicActivity.this, "共借人照片保存成功");
                            finish();
                            int enterAnim0 = R.anim.pre_enter;// 进入的activity对应的动画资源
                            int exitAnim0 = R.anim.pre_exit;// 结束的activity对应的动画资源
                            overridePendingTransition(enterAnim0, exitAnim0);
                            ...
                            MyToast.show(UpdateCautionerPicActivity.this, customeReportBean.getMsg());
                        }
