...
public class BankOkActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initRecyclerView() {
        ...
        adapter1 = new GridImageAdapter(BankOkActivity.this, onAddPicClickListener1);
        adapter1.setList(selectMedia);
        adapter1.setSelectMax(maxSelectNum);
        FullyGridLayoutManager manager = new FullyGridLayoutManager(BankOkActivity.this, 3, GridLayoutManager.VERTICAL, false);
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        ...
                        PictureConfig.getInstance().externalPicturePreview(BankOkActivity.this, position, selectMedia);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(BankOkActivity.this, selectMedia.get(position - 1).getPath());
                        }
                        break;
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    ...
                    themeStyle = ContextCompat.getColor(BankOkActivity.this, R.color.blue);//设置主题样式
                    checkedBoxDrawable = R.drawable.select_cb;//设置图片勾选样式
                    previewColor = ContextCompat.getColor(BankOkActivity.this, R.color.tab_color_true);
                    completeColor = ContextCompat.getColor(BankOkActivity.this, R.color.tab_color_true);
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(BankOkActivity.this, resultCallback);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(BankOkActivity.this, resultCallback);
                    }
                    break;
                case 1:
                    // 删除图片
    ...
    private void post2() {
        String userId = PreferenceUtils.getString(BankOkActivity.this, "userId");
        LogUtils.d("--------------->>>" + image.toString());
        OkHttpUtils
                .post()
                .url(Constants.URLS.BASEURL + "Login/auz")
                .addParams("userId", userId)
                .addParams("auz", image.toString())
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        DeleteImageUtils.DeleteImage(selectMedia, BankOkActivity.this);
                        DeleteImageUtils.DeleteCutImage(selectMedia, BankOkActivity.this);
                        ...
                        try {
                            ...
                            MyToast.show(BankOkActivity.this, "服务器连接失败");
                        }
...
// 我的爱赤裸裸 因为 我的 2  269
                            ...
                            progressDialog.dismiss();
                            MyToast.show(BankOkActivity.this, customeReportBean.getMsg());
                        }
                        finish();
                    }
                });
