...
public class FacePicActivity extends BaseActivity {
    ...
    protected int getContentView() {
        return R.layout.activity_face_pic;
    }
    ...
    private void updateToQiniu() {
        ...
        if (piccount < 1) {
            MyToast.show(FacePicActivity.this, "请上传面部照片");
            return;
        }
...
//                                }
    ...
    private void post2() {
        LogUtils.d(userId + "," + certificate_up.toString());

        OkHttpUtils
                .post()
                //http://byu2763230001.my3w.com/pcreateArchivesublic/info/Login/
                .url(Constants.URLS.BASEURL + "Appraiser/recognition")
...
//                                                                        overridePendingTransition(enterAnim6, exitAnim6);
//                                                                    }
                            startActivity(new Intent(FacePicActivity.this, ZhengxinActivity.class));

                            finish();
                            MyToast.show(FacePicActivity.this, bean.getMsg());
                            int enterAnim6 = R.anim.next_enter;// 进入的activity对应的动画资源
                            int exitAnim6 = R.anim.next_exit;// 结束的activity对应的动画资源
                            overridePendingTransition(enterAnim6, exitAnim6);
                        } else {
    ...
    class ResultCa1 implements PictureConfig.OnSelectResultCallback {
        ...
        public void onSelectSuccess(List<LocalMedia> resultList) {
            ...
            if (media.isCut() && !media.isCompressed()) {
                ...
                Glide.with(FacePicActivity.this)
                        .load(path1)
                        .centerCrop()
