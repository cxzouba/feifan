...
public class StartHomeVisitActivity extends BaseActivity implements BaiduMap.OnMapStatusChangeListener, OnGetGeoCoderResultListener {
    ...
    protected int getContentView() {
        return R.layout.activity_start_home_visit;
    }
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        hud = KProgressHUD.create(StartHomeVisitActivity.this)
...
//System.out.println(location.getAddress()+location.getLocationDescribe() + location.getAddrStr() + location.getLocTypeDescription());
    ...
    @OnClick({R.id.bt_start_visit, R.id.iv_back, R.id.img_location_back_origin})
        ...
        switch (view.getId()) {
            case R.id.bt_start_visit:
                ...
                OkHttpUtils
                        ...
                        .url(Constants.URLS.BASEURL + "Login/homeVisits")
                        .addParams("userId", PreferenceUtils.getString(this, "userId"))
                        .addParams("visitsLat", mLatitude.toString())
                        .addParams("visitsLng", mLongitude.toString())
                        .build()
                        .execute(new StringCallback() {
                            @Override
                            public void onError(Call call, Exception e, int id) {
                                LogUtils.d("startHomeActivity" + "------------->>>>>>>" + e);
                                MyToast.show(StartHomeVisitActivity.this, "提交失败");
                                hud.dismiss();
                            }
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                if (bean.getCode() == 1) {
                                    PreferenceUtils.setString(StartHomeVisitActivity.this, "userName", bean.getList().getUserName());

                                    String carLoan = bean.getList().getCarLoan();
                                    PreferenceUtils.setString(StartHomeVisitActivity.this, "carLoan", carLoan);

//                                if (carLoan.equals("2")) {
//                                    Intent intent = new Intent(StartHomeVisitActivity.this, BaseInformationActivity.class);
//                                    startActivity(intent);
//                                    finish();
//                                } else {
//                                    startActivity(new Intent(StartHomeVisitActivity.this, CarTypeActivity.class));
//                                    finish();
//                                }

                                    PreferenceUtils.setString(StartHomeVisitActivity.this, "Latitude", mLatitude.toString());
                                    PreferenceUtils.setString(StartHomeVisitActivity.this, "Longtitude", mLongitude.toString());
...
//                                    PreferenceUtils.setString(StartHomeVisitActivity.this, "json", json);
                                    ...
                                    MyToast.show(StartHomeVisitActivity.this, bean.getMsg());
                                }
