...
public class Chuli2Activity extends BaseActivity implements View.OnClickListener {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        hud = KProgressHUD.create(Chuli2Activity.this)
    ...
    private void initData() {
        ...
        String id = PreferenceUtils.getString(Chuli2Activity.this, "chuliId");
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        ...
                        MyToast.show(Chuli2Activity.this, "联网失败");
                    }
...
//                        String name = PreferenceUtils.getString(Chuli2Activity.this, "chuliName");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_back:
                startActivity(new Intent(this, GuoCheng2Activity.class));
                finish();
