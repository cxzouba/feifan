...
public class Cost1Activity extends BaseActivity implements TextWatcher {
...
//    TextView tvShijiPrice;
    ...
    public void onViewClicked(View view) {
        bottomPopupOption = new BottomPopupOption(Cost1Activity.this);
                ...
                if (!StringUtils.isEmpty(etFapiao.getText().toString())
                    ...
                    if (rbZhizu.isChecked()) {
                        if (d <= Double.parseDouble(etFapiao.getText().toString()) * 0.9) {
                            ...
                            MyToast.show(Cost1Activity.this, "选择直租时，贷款额不得大于发票价的90%");
                        ...
                        if (d <= Double.parseDouble(etFapiao.getText().toString()) * 0.85) {
                            ...
                            MyToast.show(Cost1Activity.this, "选择回租时，贷款额不得大于发票价的85%");
                        ...
                        MyToast.show(Cost1Activity.this, "请选择贷款类型");
                    }

                } else {

                    MyToast.show(Cost1Activity.this, "请填写全部信息后点击下一步");
...
//                        bank_interest = bean.getPeriods36().get(0).getBank_interest();
                    ...
                    MyToast.show(Cost1Activity.this, "请先选择贷款期数");
...
//                SmallNumberUtils.toMinus(Double.parseDouble(tvLilv.getText().toString().equals(SmallNumberUtils.toReal(Double.parseDouble(interest_0), 100) + "%") ? interest_0 : interest_1), Double.parseDouble(bank_interest), rebate));
...
//        System.out.println("rebate=" + rebate);
        ...
        OkHttpUtils
                .post()
                .url(Constants.URLS.BASEURL + "Login/newcarInterest")
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        ...
                        hud.dismiss();
                        MyToast.show(Cost1Activity.this, "联网失败");
                    }
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (postCostBean.getCode() == 1) {
                            ...
                            PreferenceUtils.setString(Cost1Activity.this, "loanPrice", tvDaikuane.getText().toString());

//                            if (creditType.equals("0")) {
//                                startActivity(new Intent(Cost1Activity.this, CustomeReport.class));
//                            } else if (creditType.equals("1")) {
//                                startActivity(new Intent(Cost1Activity.this, BankOkActivity.class));
//                            }
                            ...
                            MyToast.show(Cost1Activity.this, postCostBean.getMsg());
                        }
...
//            d = (Double.parseDouble(etDaikuane.getText().toString().equals("") ? "0" : etDaikuane.getText().toString())
...
//                    * (1 + (Double.parseDouble(tvLilv.getText().toString().equals("") ? "0" : tvLilv.getText().toString().equals(SmallNumberUtils.toReal(Double.parseDouble(interest_0), 100) + "%") ? interest_0 : interest_1)
...
//            tvDaikuane.setText(String.valueOf(daikuane));
            LogUtils.e("lilvcha", (Double.parseDouble(tvLilv.getText().toString().equals("") ? "0" : tvLilv.getText().toString().equals(SmallNumberUtils.toReal(Double.parseDouble(interest_0), 100) + "%") ? interest_0 : interest_1) -
                    Double.parseDouble(bank_interest == null ? "0" : bank_interest)) + "=");
...
//                    * Double.parseDouble(etDaikuane.getText().toString().equals("") ? "0" : etDaikuane.getText().toString()));
            ...
            e.printStackTrace();
            MyToast.show(Cost1Activity.this, "输入有误");
        }
    }
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        hud = KProgressHUD.create(Cost1Activity.this)
...
//                            tvGouzhishui.setText(String.valueOf((Double.parseDouble(etFapiao.getText().toString().equals("") ? "0" : etFapiao.getText().toString()) * 9945) / 100000));
                            ...
                            MyToast.show(Cost1Activity.this, bean.getMsg());
                        }
