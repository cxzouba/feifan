...
public class UpNewCarImageActivity extends BaseActivity implements View.OnClickListener, BaiduMap.OnMapStatusChangeListener, OnGetGeoCoderResultListener {
    ...
    protected int getContentView() {
        return R.layout.activity_carup_pic;
    }
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        /*initRecyclerView();*/
        carId = PreferenceUtils.getString(UpNewCarImageActivity.this, "carId");
...
//        companyReport.setAdapter(adapter);
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        ...
                        PictureConfig.getInstance().externalPicturePreview(UpNewCarImageActivity.this, position - 1, selectMedia5);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia5.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(UpNewCarImageActivity.this, selectMedia5.get(position - 1).getPath());
                        }
                        break;
                }
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    themeStyle = ContextCompat.getColor(UpNewCarImageActivity.this, R.color.blue);//设置主题样式
                    checkedBoxDrawable = R.drawable.select_cb;//设置图片勾选样式
                    previewColor = ContextCompat.getColor(UpNewCarImageActivity.this, R.color.tab_color_true);
                    completeColor = ContextCompat.getColor(UpNewCarImageActivity.this, R.color.tab_color_true);
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (false) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(UpNewCarImageActivity.this, resultCallback);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(UpNewCarImageActivity.this, resultCallback);
                    }
                    break;
                case 1:
                    // 删除图片
                                        ...
                                        if (percent == 1.0) {
                                            ...
                                            if (upLoadCount == piccount) {
                                                ...
                                                OkHttpUtils
                                                        ...
                                                        .url(Constants.URLS.BASEURL + "Transfer/index")
                                                        ...
                                                        .execute(new StringCallback() {
                                                            ...
                                                            public void onResponse(String response, int id) {
                                                                ...
                                                                DeleteImageUtils.DeleteImage(selectMedia, UpNewCarImageActivity.this);
...
//                                                                        overridePendingTransition(enterAnim6, exitAnim6);
//                                                                    }
                                                                    MyToast.show(UpNewCarImageActivity.this, "车辆评估已提交，请等待!");
                                                                    finish();
                                                                    int enterAnim6 = R.anim.next_enter;// 进入的activity对应的动画资源
                                                                    int exitAnim6 = R.anim.next_exit;// 结束的activity对应的动画资源
                                                                    overridePendingTransition(enterAnim6, exitAnim6);
                                                                    ...
                                                                    upLoadCount = 0;
                                                                    MyToast.show(UpNewCarImageActivity.this, bean.getMsg());
                                                                }
    ...
    class ResultCa implements PictureConfig.OnSelectResultCallback {
        ...
        public void onSelectSuccess(List<LocalMedia> resultList) {
            ...
            if (media.isCut() && !media.isCompressed()) {
                ...
                Glide.with(UpNewCarImageActivity.this)
                        .load(path)
                        .centerCrop()
