...
public class CompanyImageUpLoadActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int getContentView() {
        return R.layout.activity_company_image;
    }
...
//        }
    ...
    private void initRecyclerView() {
        ...
        adapter = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener);
        adapter.setList(selectMedia);
        adapter.setSelectMax(maxSelectNum);

        adapter1 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener1);
        adapter1.setList(selectMedia1);
        adapter1.setSelectMax(maxSelectNum);

        adapter2 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener2);
        adapter2.setList(selectMedia2);
        adapter2.setSelectMax(maxSelectNum);

        adapter3 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener3);
        adapter3.setList(selectMedia3);
        adapter3.setSelectMax(maxSelectNum);

        adapter4 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener4);
        adapter4.setList(selectMedia4);
        adapter4.setSelectMax(maxSelectNum);

        adapter5 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener5);
        adapter5.setList(selectMedia5);
        adapter5.setSelectMax(maxSelectNum);

        adapter6 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener6);
        adapter6.setList(selectMedia6);
        adapter6.setSelectMax(maxSelectNum);

        adapter7 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener7);
        adapter7.setList(selectMedia7);
        adapter7.setSelectMax(maxSelectNum);

        adapter8 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener8);
        adapter8.setList(selectMedia8);
        adapter8.setSelectMax(maxSelectNum);

        adapter9 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener9);
        adapter9.setList(selectMedia9);
        adapter9.setSelectMax(maxSelectNum);


        adapter10 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener10);
        adapter10.setList(selectMedia10);
        adapter10.setSelectMax(maxSelectNum);

        adapter11 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener11);
        adapter11.setList(selectMedia11);
        adapter11.setSelectMax(maxSelectNum);

        adapter12 = new GridImageAdapter(CompanyImageUpLoadActivity.this, onAddPicClickListener12);
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        ...
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter1.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia1);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia1.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter2.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia2);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia2.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter3.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia3);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia3.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter4.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia4);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia4.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter5.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia5);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia5.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter6.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia6);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia6.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter7.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia7);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia7.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter8.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia8);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia8.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter9.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia9);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia9.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter10.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia10);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia10.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter11.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia11);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia11.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        adapter12.setOnItemClickListener(new GridImageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        // 预览图片 可长按保存 也可自定义保存路径
                        PictureConfig.getInstance().externalPicturePreview(CompanyImageUpLoadActivity.this, position - 1, selectMedia12);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(CompanyImageUpLoadActivity.this, selectMedia12.get(position - 1).getPath());
                        }
                        break;
                }
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    themeStyle = ContextCompat.getColor(CompanyImageUpLoadActivity.this, R.color.blue);//设置主题样式
                    checkedBoxDrawable = R.drawable.select_cb;//设置图片勾选样式
                    previewColor = ContextCompat.getColor(CompanyImageUpLoadActivity.this, R.color.tab_color_true);
                    completeColor = ContextCompat.getColor(CompanyImageUpLoadActivity.this, R.color.tab_color_true);
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback);
                    }
                    break;
                case 1:
                    // 删除图片
    ...
    private void postData() {
        ...
        if (selectMedia.size() == 0 || selectMedia1.size() == 0 || selectMedia2.size() == 0 || selectMedia3.size() == 0 || selectMedia4.size() == 0 || selectMedia5.size() == 0 || selectMedia6.size() == 0 || selectMedia7.size() == 0|| selectMedia9.size() == 0|| selectMedia10.size() == 0 || selectMedia11.size() == 0 || selectMedia12.size() == 0) {
            MyToast.show(this, "当前企业有图片未上传，请检查");
            return;
                                ...
                                public void progress(String key, double percent) {
                                    ...
                                    if (percent == 1.0) {
                                        ...
                                        if (upLoadCount == piccount) {
                                            LogUtils.d("--------------->>>" + businessPic.toString());
                                            String companyId = PreferenceUtils.getString(CompanyImageUpLoadActivity.this, "userId");
                                            OkHttpUtils
                                                    .post()
                                                    .url(Constants.URLS.BASEURL + "Login/addCompanyPic")
                                                    .addParams("companyId", companyId)
                                                    .addParams("picarr", picarr.toString())
                                                    .addParams("reportPic", reportPic.toString())
                                                    .addParams("cardPic", cardPic.toString())
                                                    .addParams("recordingPic", recordingPic.toString())
                                                    .addParams("bankflowPic", bankflowPic.toString())
                                                    .addParams("financialPic", financialPic.toString())
                                                    .addParams("propertyPic", propertyPic.toString())
                                                    .addParams("usedcarPic", usedcarPic == null ? "null" : usedcarPic.toString())
                                                    .addParams("vehiclePic", vehiclePic == null ? "null" : vehiclePic.toString())
                                                    .addParams("vehicleLicense", vehicleLicense == null ? "null" : vehicleLicense.toString())
                                                    .addParams("creditReporting", creditReporting.toString())
                                                    .addParams("visitsPic", visitsPic.toString())
                                                    .addParams("businessPic", businessPic.toString())
                                                    .build()
                                                    .execute(new StringCallback() {
                                                        @Override
                                                        public void onError(Call call, Exception e, int id) {
                                                            LogUtils.e("compangPic=========" + e);
                                                            MyToast.show(CompanyImageUpLoadActivity.this, "联网失败");
                                                        ...
                                                        public void onResponse(String response, int id) {
                                                            ...
                                                            if (bean.getCode() == 1) {
                                                                Intent intent = new Intent(CompanyImageUpLoadActivity.this, UpLoadCompanyVideoActivity.class);
                                                                progressDialog.dismiss();
                                                                ...
                                                                MyToast.show(CompanyImageUpLoadActivity.this, bean.getMsg());
                                                                progressDialog.dismiss();
                                                            }
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback1);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback1);
                    }
                    break;
                case 1:
                    // 删除图片
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback2);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback2);
                    }
                    break;
                case 1:
                    // 删除图片
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback3);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback3);
                    }
                    break;
                case 1:
                    // 删除图片
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback4);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback4);
                    }
                    break;
                case 1:
                    // 删除图片
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback6);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback6);
                    }
                    break;
                case 1:
                    // 删除图片
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback7);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback7);
                    }
                    break;
                case 1:
                    // 删除图片
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback8);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback8);
                    }
                    break;
                case 1:
                    // 删除图片
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback10);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback10);
                    }
                    break;
                case 1:
                    // 删除图片
            ...
            switch (type) {
                case 0:
                    ...
                    FunctionOptions options = new FunctionOptions.Builder()
                            ...
                            .setSelectMedia(selectMedia11
                            ) // 已选图片，传入在次进去可选中，不能传入网络图片
                            .setCompressFlag(1) // 1 系统自带压缩 2 luban压缩
                            .setCompressW(0) // 压缩宽 如果值大于图片原始宽高无效
                            .setCompressH(0) // 压缩高 如果值大于图片原始宽高无效
                            .setThemeStyle(themeStyle) // 设置主题样式
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback11);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback11);
                    }
                    break;
                case 1:
                    // 删除图片
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback9);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback9);
                    }
                    break;
                case 1:
                    // 删除图片
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback12);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback12);
                    }
                    break;
                case 1:
                    // 删除图片
...
//                            .setImmersive(false)// 是否改变状态栏字体颜色(黑色)
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(CompanyImageUpLoadActivity.this, resultCallback5);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(CompanyImageUpLoadActivity.this, resultCallback5);
                    }
                    break;
                case 1:
                    // 删除图片
