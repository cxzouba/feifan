...
public class OutdoorPicActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initRecyclerView() {
        ...
        adapter1 = new GridImageAdapter(OutdoorPicActivity.this, onAddPicClickListener1);
        adapter1.setList(selectMedia);
        adapter1.setSelectMax(maxSelectNum);
        FullyGridLayoutManager manager = new FullyGridLayoutManager(OutdoorPicActivity.this, 3, GridLayoutManager.VERTICAL, false);
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        ...
                        PictureConfig.getInstance().externalPicturePreview(OutdoorPicActivity.this, position, selectMedia);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(OutdoorPicActivity.this, selectMedia.get(position - 1).getPath());
                        }
                        break;
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    ...
                    themeStyle = ContextCompat.getColor(OutdoorPicActivity.this, R.color.blue);//设置主题样式
                    checkedBoxDrawable = R.drawable.select_cb;//设置图片勾选样式
                    previewColor = ContextCompat.getColor(OutdoorPicActivity.this, R.color.tab_color_true);
                    completeColor = ContextCompat.getColor(OutdoorPicActivity.this, R.color.tab_color_true);
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(OutdoorPicActivity.this, resultCallback);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(OutdoorPicActivity.this, resultCallback);
                    }
                    break;
                case 1:
                    // 删除图片
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_next) {
            ...
            if (selectMedia.size() < 6) {
                MyToast.show(OutdoorPicActivity.this, "请上传最少六张室外照片");
                return;
            }
    ...
    private void post2() {
        String userId = PreferenceUtils.getString(OutdoorPicActivity.this, "userId");
        ...
        OkHttpUtils
                ...
                .addParams("outdoor", image.toString())
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        DeleteImageUtils.DeleteImage(selectMedia, OutdoorPicActivity.this);
                        DeleteImageUtils.DeleteCutImage(selectMedia, OutdoorPicActivity.this);
                        ...
                        try {
                            ...
                            MyToast.show(OutdoorPicActivity.this, "服务器连接失败");
                        }
...
// 我的爱赤裸裸 因为 我的 2  269
                            ...
                            startActivity(new Intent(OutdoorPicActivity.this, IndoorPicActivity.class));
                            finish();
                            ...
                            upLoadCount = 0;
                            progressDialog.dismiss();
                            MyToast.show(OutdoorPicActivity.this, customeReportBean.getMsg());
                        }
                        finish();
                    }
                });
