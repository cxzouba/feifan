...
public class DiYaActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initRecyclerView() {
        ...
        adapter1 = new GridImageAdapter(DiYaActivity.this, onAddPicClickListener1);
        adapter1.setList(selectMedia);
        adapter1.setSelectMax(maxSelectNum);
        FullyGridLayoutManager manager = new FullyGridLayoutManager(DiYaActivity.this, 3, GridLayoutManager.VERTICAL, false);
            ...
            public void onItemClick(int position, View v) {
                switch (selectType) {
                    case FunctionConfig.TYPE_IMAGE:
                        ...
                        PictureConfig.getInstance().externalPicturePreview(DiYaActivity.this, position, selectMedia);
                        break;
                    case FunctionConfig.TYPE_VIDEO:
                        // 预览视频
                        if (selectMedia.size() > 0) {
                            PictureConfig.getInstance().externalPictureVideo(DiYaActivity.this, selectMedia.get(position - 1).getPath());
                        }
                        break;
                }
        ...
        public void onAddPicClick(int type, int position) {
            switch (type) {
                case 0:
                    ...
                    themeStyle = ContextCompat.getColor(DiYaActivity.this, R.color.blue);//设置主题样式
                    checkedBoxDrawable = R.drawable.select_cb;//设置图片勾选样式
                    previewColor = ContextCompat.getColor(DiYaActivity.this, R.color.tab_color_true);
                    completeColor = ContextCompat.getColor(DiYaActivity.this, R.color.tab_color_true);
                    ...
                    if (mode) {
                        // 只拍照
                        PictureConfig.getInstance().init(options).startOpenCamera(DiYaActivity.this, resultCallback);
                    } else {
                        // 先初始化参数配置，在启动相册
                        PictureConfig.getInstance().init(options).openPhoto(DiYaActivity.this, resultCallback);
                    }
                    break;
                case 1:
                    // 删除图片
    ...
    private void post2() {
        ...
        String userId = PreferenceUtils.getString(DiYaActivity.this, "userId");
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        LogUtils.e("diya------------->>>>" + response);
                        DeleteImageUtils.DeleteImage(selectMedia, DiYaActivity.this);
                        DeleteImageUtils.DeleteCutImage(selectMedia, DiYaActivity.this);
                        ...
                        try {
                            ...
                            MyToast.show(DiYaActivity.this, "服务器连接失败");
                        }
...
//                            }
                            ...
                            startActivity(new Intent(DiYaActivity.this, TeamManager1Activity.class));
                            finish();
                            ...
                            progressDialog.dismiss();
                            MyToast.show(DiYaActivity.this, customeReportBean.getMsg());
                        }
                    }
                });
    }
