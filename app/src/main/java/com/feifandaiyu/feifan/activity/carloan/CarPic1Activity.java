...
public class CarPic1Activity extends BaseActivity implements View.OnClickListener {
    ...
    private void showImage() {
        ...
        if (bean.getList().get(0).getAppenhance_pic() == null) {
            new AlertDialog.Builder(CarPic1Activity.this)
                    .setMessage("暂无照片,是否上传车辆照片")
                    .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            CarPic1Activity.this.finish();
                        }
                    })
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            startActivity(new Intent(CarPic1Activity.this, UpLoadCarImageActivity.class));
                            CarPic1Activity.this.finish();
                        }
                    })
                    .setCancelable(false)
            ...
            try {
//                LogUtils.e(bean.getList().get(0).getAppenhance_pic().get(0).split(",")[0]);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getAppenhance_pic().get(0).split(",")[0], R.drawable.crabgnormal, waiguanZhengqian);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getAppenhance_pic().get(1).split(",")[0], R.drawable.crabgnormal, waiguanZhenghou);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getAppenhance_pic().get(2).split(",")[0], R.drawable.crabgnormal, waiguanZuoqian);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getAppenhance_pic().get(3).split(",")[0], R.drawable.crabgnormal, waiguanYouqian);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getAppenhance_pic().get(4).split(",")[0], R.drawable.crabgnormal, waiguanZuohou);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getAppenhance_pic().get(5).split(",")[0], R.drawable.crabgnormal, waiguanYouhou);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getAppenhance_pic().get(6).split(",")[0], R.drawable.crabgnormal, waiguanFengdang);

                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getControl_pic().get(0).split(",")[0], R.drawable.crabgnormal, zhongkongLicheng);

                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getStructure_pic().get(0).split(",")[0], R.drawable.crabgnormal, neibuMingpai);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getStructure_pic().get(1).split(",")[0], R.drawable.crabgnormal, neibuFadongji);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getStructure_pic().get(2).split(",")[0], R.drawable.crabgnormal, neibuHoubeixing);

                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(0).split(",")[0], R.drawable.crabgnormal, fujiaDengji1);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(1).split(",")[0], R.drawable.crabgnormal, fujiaDengji2);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(2).split(",")[0], R.drawable.crabgnormal, fujiaDengji3);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(3).split(",")[0], R.drawable.crabgnormal, fujiaDengji4);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(4).split(",")[0], R.drawable.crabgnormal, fujiaDengji5);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(5).split(",")[0], R.drawable.crabgnormal, fujiaDengji6);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(6).split(",")[0], R.drawable.crabgnormal, fujiaDengji7);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(7).split(",")[0], R.drawable.crabgnormal, fujiaDengji8);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(8).split(",")[0], R.drawable.crabgnormal, fujiaDengji9);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(9).split(",")[0], R.drawable.crabgnormal, fujiaXinshiZheng);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(10).split(",")[0], R.drawable.crabgnormal, fujiaXinshiFu);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(11).split(",")[0], R.drawable.crabgnormal, fujiaXinshiJian);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(12).split(",")[0], R.drawable.crabgnormal, fujiaShangxian);
                ImageViewUtils.showNetImage(CarPic1Activity.this, bean.getList().get(0).getChassis_pic().get(13).split(",")[0], R.drawable.crabgnormal, fujiaQiangxian);

                otherPic.setAdapter(new CarPicAdapter(CarPic1Activity.this, bean));
