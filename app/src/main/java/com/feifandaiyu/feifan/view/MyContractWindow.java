...
public class MyContractWindow extends PopupWindow {
    ...
    private final Button aggress;

    public MyContractWindow(final Context mContext) {

        this.view = LayoutInflater.from(mContext).inflate(R.layout.pop_contract, null);

        wvXieyi = (WebView) view.findViewById(R.id.wv_xieyi);
        aggress = (Button) view.findViewById(R.id.agress);
        ...
        wvXieyi.loadUrl("http://specaildata.hrbffdy.com/index.html");
        ...
        aggress.setOnClickListener(new View.OnClickListener() {
            @Override
